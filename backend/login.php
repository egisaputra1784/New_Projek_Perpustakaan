...
// var_dump($hash);
// var_dump(password_verify('a', $hash));
...
if (isset($_POST['login_user'])) {
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM `user` WHERE username = '$usernameUser'");
                            ...
                            <div class="col-lg-6" style="width: 850px;">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="" class="user">
                                        ...
                                        <button type="submit" name="login_user" id="login_user" class="btn btn-primary1 btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
