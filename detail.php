...
<head>
    ...
    <style>
        ...
        .canvas-container {
            ...
            height: 400px;
            z-index: 2;
            /* Pastikan canvas berada di depan */
            background-color: transparent;
            /* Hapus latar belakang putih */
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.5);
            /* Jika perlu drop shadow */
        }

        .judul-overlay {
            margin-top: 80px;
            color: white !important;
            /*FUNGSI IMPORTANT UNTUK MEMPRIORITASKAN KODE DICSS  */
            position: relative;
            z-index: 10;
        ...
        /* Media query untuk menyesuaikan padding-top pada layar kecil */
...
<body class="profile-page sidebar-collapse">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg fixed-top" color-on-scroll="300" style="height: 100px;">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="index.php" style=" font-weight: bold; font-size: 25px; ">
                    The Library
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a href="pinjam.php" class="nav-link" style=" font-size: 18px; padding: 0 15px; line-height: 90px; font-weight:bold;">Pinjam</a>
                    </li>
                    <li class="nav-item">
                        <a href="Buku.php"
                            class="nav-link" style=" font-size: 18px; padding: 0 15px; line-height: 90px;  font-weight:bold;"> Buku</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="page-header page-header-xs" data-parallax="true" style="background-image: url('./backend/assets/upload_gambar/<?= $data['gambar'] ?>'); backdrop-filter: blur(3px);">
        ...
        <!-- Teks judul di atas background -->
        <div class="judul-overlay">
            <h2 class="title" style="margin-bottom: -7px;"><?= $data['judul'] ?></h2>
            <h6 class="pengarang" style="color: white; margin-bottom: -5px;"><?= $data['pengarang'] ?></h6>
            <h6 class="genre" style="color: white; margin-bottom: 5px;"><?= $data['genre'] ?></h6>
            <div class="data">
    ...
    <div class="row">
        ...
        <div class="canvas-container">
            ...
            <div id="sinopsis">
                <p style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 30px; line-height: 1.5; margin-bottom: -30px; color:black; padding-top: 10px; font-weight:bold;">ABOUT</p>
                <p style="text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: 17px; line-height: 1.5; color:black; padding-top: 30px;"><?= $data['sinopsis'] ?></p>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="credits ml-auto mr-auto">
                    <btn class="btn btn-outline-default btn-round" style="margin-left: 10rem; margin-top:15px" data-toggle="modal" data-target="#tambahModal">
                        Booking <i class="nc-icon nc-tag-content"></i></btn>

                </div>

                <div id="detail" class="detail" style="margin-left: 20rem;">
                    <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
